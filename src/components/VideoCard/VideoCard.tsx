...
import { ghostVariants } from '../primitives/ghost-variants';
      ...
      thumbnail={
        <>
          ...
          <Image
            ...
            className={cn(
              'object-cover transition-all duration-100 group-hover:scale-105',
